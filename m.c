...
void print_entry_banner() {
    ...
    printf("\033[1;35m║                                                                                ║\033[0m\n");
    printf("\033[1;35m║                \033[1;36m★ ★ ★ \033[1;32m W E L C O M E T O M Y S P I D Y M A G I C W O R L D \033[1;36m★ ★ ★               ║\033[0m\n");
    printf("\033[1;35m║                                                                                ║\033[0m\n");
    printf("\033[1;35m║                      \033[1;33m★ \033[1;31m S P I D Y O W N E R O P   B G M I G A N D F A D O \033[1;33m★                      ║\033[0m\n");
    printf("\033[1;35m║                                                                                ║\033[0m\n");
...
void print_stylish_text() {
    printf("\033[1;35m╔════════════════════════════════════════════════════════════╗\033[0m\n");
    printf("\033[1;35m║ \033[1;36m★ \033[1;32mS P I D Y O W N E R O P  -   D D O S M A C H I N E ! \033[1;36m★ \033[1;35m║\033[0m\n");
    printf("\033[1;35m╠════════════════════════════════════════════════════════════╣\033[0m\n");
    ...
    printf("\033[1;35m║ \033[1;33m✦ Status:           \033[1;32m UDP ATTACK START        \033[1;35m║\033[0m\n");
    printf("\033[1;35m║ \033[1;33m✦ Note:             \033[1;33mExpire hone ke baad paise de bhadwe!    \033[1;35m║\033[0m\n");
    printf("\033[1;35m║ \033[1;33m✦ Contact:          \033[1;32m@SPIDY_OWNEROP                             \033[1;35m║\033[0m\n");
    printf("\033[1;35m╚════════════════════════════════════════════════════════════╝\033[0m\n\n");
}
...
int main(int argc, char *argv[]) {
    if (strcmp(argv[0], "./spidy") != 0) {
        fprintf(stderr, "Error: Rename binary to 'spidy' and run again.\n");
        return 1;
    }
    ...
    if (is_expired()) {
        fprintf(stderr, "\033[1;31mERROR: File expired. Contact @SPIDY_OWNEROP for new version.\033[0m\n");
        return 1;
    }
    ...
    printf("\033[1;34mAttack Finished. Contact @SPIDY_OWNEROP for more.\033[0m\n");
    return 0;
}