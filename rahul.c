...
void print_entry_banner() {
    ...
    printf("\033[1;35m║                                                                                ║\033[0m\n");
    printf("\033[1;35m║                \033[1;36m★ ★ ★ \033[1;32mW E L C O M E   T O   T H E   R A H U L   K I   D U N I Y A \033[1;36m★ ★ ★               ║\033[0m\n");
    printf("\033[1;35m║                                                                                ║\033[0m\n");
    printf("\033[1;35m║                      \033[1;33m★ \033[1;31mR A H U L   B H A I   R A H U L  B H A I.  K A  S Y S T E M \033[1;33m★                      ║\033[0m\n");
    printf("\033[1;35m║                                                                                ║\033[0m\n");
...
void print_stylish_text() {
    printf("\033[1;35m╔════════════════════════════════════════════════════════════╗\033[0m\n");
    printf("\033[1;35m║ \033[1;36m★ \033[1;32mP A P A   R A H U L   -   T E R R O R   M A C H I N E \033[1;36m★ \033[1;35m║\033[0m\n");
    printf("\033[1;35m╠════════════════════════════════════════════════════════════╣\033[0m\n");
...
int main(int argc, char *argv[]) {
    if (strcmp(argv[0], "./Rahul") != 0) {
        fprintf(stderr, "Error: Rename binary to 'Rahul' and run again.\n");
        return 1;
    }
    ...
    if (is_expired()) {
        fprintf(stderr, "\033[1;31mERROR: File expired. Contact @RAHUL BHAI for new version.\033[0m\n");
        return 1;
    }
    ...
    printf("\033[1;34mAttack Finished. Contact @RAHUL BHAI for more.\033[0m\n");
    return 0;
}